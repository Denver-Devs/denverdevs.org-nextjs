...
export default function Home() {
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <li>Personal insults, particularly those related to gender, sexual orientation, race, age, religion/nonreligion, or disability.</li>
      ...
      <li>Sustained disruption of on-topic channels. Disruption is only okay in #topic-random because anarchy. </li>
      ...
      <p>If you are subject to or witness unacceptable behavior, or have any other concerns, please notify a Denver Devs admin as soon as possible. info@denverdevs.org.</p>
      ...
      <p><a href="mailto:info@denverdevs.org">info@denverdevs.org</a></p>
